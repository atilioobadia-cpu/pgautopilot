...
export const RawQueryArgs = z.object({
  sql: z.string().describe("Raw read-only SQL SELECT statement, must include LIMIT"),
});
...
export const toolDefinitions = {
  ...
  db_update_many: {
    title: "Update Rows",
    description:
      "Update all rows matching a filter. Empty filter updates every row -- use with care.",
